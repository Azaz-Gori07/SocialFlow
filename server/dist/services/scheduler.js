    ...
    start: () => {
        ...
        setInterval(async () => {
            try {
                ...
                const commentsPool = commentsByPlatform[randomAccount.platform] || ['Nice post!'];
                ...
                const newComment = await db_1.db.comments.create({
        ...
        setInterval(async () => {
            try {
                ...
                for (const account of accounts) {
                    ...
                    const todayRecord = await db_1.db.analytics.findOne({
                    ...
                    if (todayRecord) {
                        await db_1.db.analytics.updateOne({ _id: todayRecord._id }, {
                            $inc: {
                        ...
                        const records = await db_1.db.analytics.find({ accountId: account._id });
